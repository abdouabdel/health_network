...
<div class="mdl-grid full-grid margin-top-0 padding-0">
	<div class="mdl-cell mdl-cell mdl-cell--12-col mdl-cell--12-col-phone mdl-cell--8-col-tablet mdl-cell--12-col-desktop mdl-card mdl-shadow--3dp margin-top-0 padding-top-0">
	    <div class="mdl-card card-wide" style="width:100%;" itemscope itemtype="http://schema.org/Person">
			...
			<div class="mdl-card__title" @if ($user->user_profile_bg != NULL) style="background: url('{{$user->user_profile_bg}}') center/cover;" @endif>
					        ...
					        @if ($user->twitter_username)
								<li class="mdl-list__item">
									<span class="mdl-list__item-primary-content">
										...
										{!! HTML::link('https://twitter.com/'.$user->twitter_username, $user->twitter_username, array('class' => 'twitter-link mdl-typography--font-light', 'target' => '_blank')) !!}
									</span>
								</li>
					        @endif
					        @if ($user->github_username)
						        <li class="mdl-list__item">
						        	<span class="mdl-list__item-primary-content">
										...
										{!! HTML::link('https://github.com/'.$user->github_username, $user->github_username, array('class' => 'github-link mdl-typography--font-light', 'target' => '_blank')) !!}
						        	</span>
						        </li>
					        @endif
					        @if ($user->bio)
